grammar FormativeExamGrammar;
options { caseInsensitive=true;}

start: exam EOF;

exam: exam_header NEWLINE* section+;

exam_header: EXAM_HEADER_SYMBOL
             title
             EXAM_HEADER_SYMBOL
             description;

title: SENTENCE END_SYMBOL;

description: (SENTENCE NEWLINE*)+ END_SYMBOL;
...
section_header: SECTION_HEADER_SYMBOL
                title
                SECTION_HEADER_SYMBOL
                description;
...
EXAM_HEADER_SYMBOL: '::' (WHITESPACE | NEWLINE)*;
SECTION_HEADER_SYMBOL: '//' (WHITESPACE | NEWLINE)*;
